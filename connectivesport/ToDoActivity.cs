...
//#else
//        private IMobileServiceTable<User> todoTable;
//#endif
...
//            // Get the sync table instance to use to store User rows.
//            todoTable = client.GetSyncTable<User>();
//#else
//            todoTable = client.GetTable<User>();
//#endif
...
//                if (pullData) {
//                    await todoTable.PullAsync("allUsers", todoTable.CreateQuery()); // query ID is used for incremental sync
//                }
//            }
