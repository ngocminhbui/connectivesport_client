...
namespace connectivesport
{
    class LocalDataManager
    {
		...
		public List<Challenge> lsChallenge;
        public List<User> lsUser;
		public List<User> lsUserChallenge;
        ...
        public LocalDataManager()
        {
            ...
            lsMedal = loadMedal();
            lsUser = loadUser();
			lsUserChallenge = loadUserChallege();
			lsChallenge = loadChallenge();
        }
		...
		private List<User> loadUser()
        {
            ...
            User user3 = new User { UserID = "user3", Id = "user3", Username = "Do Trong Le", Email = "dtle@gmail.com", LastLocationX = 10.7531633, LastLocationY = 106.6616659, LastLogin = DateTime.Now, AvatarURL = "avatar_le" };
                        User user4 = new User { UserID = "user4", Id = "user4", Username = "Le Dinh Han", Email = "dtle@gmail.com", LastLocationX = 10.7531633, LastLocationY = 106.6616659, LastLogin = DateTime.Now, AvatarURL = "avatar_han" };
			            User user5 = new User { UserID = "user5", Id = "user5", Username = "Le Minh Son", Email = "dtle@gmail.com", LastLocationX = 10.7531633, LastLocationY = 106.6616659, LastLogin = DateTime.Now, AvatarURL = "avatar_son" };
		...
		private List<User> loadUserChallege()
		{
			List<User> result = new List<User>();
			//User user1 = new User { UserID = "user1", Id = "user1", Username = "Luong Quoc An", Email = "lqa@gmail.com", LastLocationX = 10.7549819, LastLocationY = 106.6614459, LastLogin = DateTime.Now, AvatarURL = "https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/11207295_792318130877638_232756703618362371_n.jpg?oh=d3e1f303d32252ae230a592132683b24&oe=595C1C5B" };
			//User user2 = new User { UserID = "user2", Id = "user2", Username = "Bui Ngoc Minh", Email = "nminhbui@gmail.com", LastLocationX = 10.7533198, LastLocationY = 106.6631528, LastLogin = DateTime.Now, AvatarURL = "https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/14202620_600734660087573_1014109962882287185_n.jpg?oh=7010e437355909cdf4e6d2c0a506c8b6&oe=5953FD4E" };
		...
		internal Challenge getChallengeById(string challengeId)
		{
			return lsChallenge.Find(x => x.Id == challengeId);		
		}
		...
		private List<Challenge> loadChallenge()
		{
			List<Challenge> Result = new List<Challenge>();
			Challenge g1 = new Challenge { CustomMessage = "Pushing up 10 time a day", Id = "c1", SportId = "sprt1" };
			//Result.Add(g1);
		...
		private List<Goal> loadGoal()
        {
			...
			Goal g1 = new Goal { CustomMessage = "Burn 1000 calories a day", BattleForRank = 5, Count = 1000, Frequency = 0, Id = "g1", SportId = "sprt1", UserId = "user1", Length = 0.0, DateAccepted = DateTime.Now, DateCompleted = null, Current_Count = 876, Current_Frequency = 0, Current_Length = 0, Current_ProposedTime = 0};
            Result.Add(g1);
